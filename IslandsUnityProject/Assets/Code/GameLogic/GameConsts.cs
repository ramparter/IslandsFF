...
public class GameConsts
{
    ...
    public class Menu
    {
        ...
        public const float TitleFontSize = 60;

        // "Please wait" message settings:
        public const float PleaseWaitFontSize = 36;

        // Play button
        public const float MedButtonFontSize = 36;
        public const float MedButtonWidth = 240;
        public const float MedButtonHeight = 80;

        public const float SmButtonFontSize = 36;
        public const float SmButtonWidth = 240;
        public const float SmButtonHeight = 80;

        // Achievements and leaderboards buttons
        public const float AchButtonY = -MedButtonHeight / 2;
        public const float AchButtonX = -240 - MedButtonWidth / 2;
        public const float LbButtonX = 240 - MedButtonWidth / 2;
        public const float LbButtonY = AchButtonY;

        // Sign-in button
        public const float SignInButtonX = -580;
        public const float SignInButtonY = MedButtonHeight + 150;

        // Placement of Google+ logo
        public const float GooglePlusLogoX = -550;
        public const float GooglePlusLogoY = SignInButtonY - 10;
        public const float GooglePlusLogoSize = 60;

        // Placement of the version string
        public const float BuildStringX = 20;
        public const float BuildStringY = 50;
        public const float BuildStringFontSize = 26;

        // Sign-in encouragement text
        public const float SignInBlurbX = 120;
        public const float SignInBlurbY = SignInButtonY - SignInBlurbFontSize * 1.1f;
