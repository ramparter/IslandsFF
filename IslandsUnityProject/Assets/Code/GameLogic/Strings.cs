...
public class Strings {
    ...
    public const string axisSensX = "Axis Sens X", axisSensY = "Axis Sens Y", axisDeadzone = "Axis DeadZone",
            holdButtonEnabled = "Hold Button Enabled",
            playerName = "Player Name";

    public const string GameTitle = "Islands";
    public const string BuildString = "Version 0.2 Alpha";
